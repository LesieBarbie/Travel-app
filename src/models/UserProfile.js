/**
 * Модель UserProfile (Профіль користувача).
 *
 * Сутність представляє статистику мандрівника - його прогрес,
 * кількість відвіданих країн, ім'я та дату реєстрації. Використовується
 * на екрані профілю для відображення загального прогресу користувача.
 */
